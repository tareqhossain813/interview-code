...
const FormContainer = () => {
    ...
    useEffect(() => {
        if (selectedValues?.length === 0 && userData?.sectors)
            setSelectedValues(userData.sectors);
                    ...
                    <div className="card-header bg-white py-3 col d-flex justify-content-between align-items-center">
                        ...
                        {!editing ? (
                            ...
                            <button
                                ...
                                onClick={() =>
                                    updateUserData(userName, selectedValues)
                                }
                            >
                ...
                <div className="card-body p-5">
                    ...
                    <form onSubmit={onSubmit} disabled={!editing}>
                        ...
                        >
                            ...
                            {console.log("Checking", userData?.sectors)}
